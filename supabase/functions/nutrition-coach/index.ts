...
function buildSystem(ctx: PlanContext): string {
  return [
    ...
    "- Prefer affordable, everyday Tunisian foods such as eggs, tuna, lbenna/yogurt, bread, couscous, lentils/chickpeas, seasonal vegetables, chicken. Budget-friendly staples, not fancy imports. You do NOT know exact current prices, so speak in terms of cheap/humble foods, not dinar amounts.",
    "- Plan the meals that realistically REMAIN given the current time. Their usual pattern is 3 meals + an afternoon snack (breakfast before 10:00, lunch 12 to 14, afternoon snack 16 to 17, dinner 19 to 21). But CHECK what they have already eaten today; do not assume a meal happened just because its time has passed.",
